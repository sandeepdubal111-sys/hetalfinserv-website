...
export const SERVICES = [
  {
    ...
    bullets: [
      ...
      "PPF & tax-efficient savings planning",
  ...
  },
  {
    ...
    tagline: "Mutual Funds, PMS, AIF, SIF, Bonds, NPS & Fixed Deposits — every product, one relationship.",
    bullets: [
      "Mutual Funds (SIP / Lumpsum) — 25+ AMC partners",
      "Portfolio Management Services (PMS Distributor, APRN00234)",
      "Alternative & Specialized Investment Funds (AIF / SIF)",
      "Bonds, NCDs & Sovereign Gold Bonds (SGB)",
